...
\newpagestyle{ruled}{
	\sethead{\includegraphics[width=3.7cm]{./images/UADE_LARGE}}
			{\parbox[b]{0.50\textwidth}{\raggedright\fontsize{8.5}{10}\selectfont\MakeUppercase{Plataforma de apoyo al an\'alisis estructural de resonancia magn\'etica lumbar mediante segmentaci\'on anat\'omica asistida por inteligencia artificial}}}
			{
				\raisebox{1.5ex}{%
