...
PFI propuesto & Prototipo académico & Segmentación de vértebras, discos y canal; mediciones simples; visualización; salida editable. & Aporte centrado en integración reproducible, trazabilidad y validación técnica/cualitativa. \\
\hline
\end{tabularx}
\end{table}
...
\begin{tabularx}{\textwidth}{p{0.13\textwidth} p{0.11\textwidth} p{0.15\textwidth} p{0.15\textwidth} p{0.16\textwidth} p{0.14\textwidth}}
\hline
