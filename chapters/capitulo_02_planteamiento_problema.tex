...
La dificultad no se ubica en reemplazar la interpretaci\'on profesional, sino en asistir tareas operativas espec\'ificas. Un sistema de apoyo puede proponer segmentaciones, calcular mediciones geom\'etricas y presentar resultados visuales, pero debe permitir revisi\'on, correcci\'on o descarte por parte del usuario.

Desde una perspectiva de ingenier\'ia, el desaf\'io consiste en integrar carga de im\'agenes, preprocesamiento, segmentaci\'on autom\'atica, mediciones, visualizaci\'on superpuesta y salida editable en un flujo coherente. La soluci\'on debe ser trazable, reproducible y acotada al contexto acad\'emico, sin presentarse como producto cl\'inico certificado ni como sistema de diagn\'ostico aut\'onomo.
